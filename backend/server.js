...
// Middleware
app.use(cors());           // pozwala frontendowi łączyć się z API
app.use(express.json());   // parsuje JSON w body requestów
...
// POST /api/categories - dodaj nową kategorię
...
// GET /api/expenses/:id - pobierz jeden wydatek
